package com.xujun.charting.charts;
...
import com.xujun.charting.data.BarDataSet;
import com.xujun.charting.data.BarLineScatterCandleData;
import com.xujun.charting.data.BarLineScatterCandleRadarDataSet;
import com.xujun.charting.data.Entry;
import com.xujun.charting.data.filter.Approximator;
import com.xujun.charting.interfaces.OnDrawListener;
import com.xujun.charting.listener.BarLineChartTouchListener;
import com.xujun.charting.utils.Highlight;
import com.xujun.charting.utils.Legend;
import com.xujun.charting.utils.LimitLine;
import com.xujun.charting.utils.PointD;
import com.xujun.charting.utils.SelInfo;
import com.xujun.charting.utils.Utils;
import com.xujun.charting.utils.XLabels;
import com.xujun.charting.utils.YLabels;
...
public abstract class BarLineChartBase<T extends BarLineScatterCandleData<? extends BarLineScatterCandleRadarDataSet<? extends Entry>>>
    ...
    protected void calculateOffsets() {
        ...
        if (mDrawLegend && mLegend != null && mLegend.getPosition() != Legend.LegendPosition.NONE) {
            ...
            if (mLegend.getPosition() == Legend.LegendPosition.RIGHT_OF_CHART
                ...
                if (mXLabels.getPosition() == XLabels.XLabelPosition.TOP)
        ...
        if (mDrawYLabels) {
            ...
            if (mYLabels.getPosition() == YLabels.YLabelPosition.LEFT) {

                yleft = ylabelwidth;
                mYLabelPaint.setTextAlign(Align.RIGHT);

            } else if (mYLabels.getPosition() == YLabels.YLabelPosition.RIGHT) {

                yright = ylabelwidth;
                mYLabelPaint.setTextAlign(Align.LEFT);

            } else if (mYLabels.getPosition() == YLabels.YLabelPosition.BOTH_SIDED) {
        ...
        if (mDrawXLabels) {
            ...
            if (mXLabels.getPosition() == XLabels.XLabelPosition.BOTTOM) {

                xbottom = xlabelheight;

            } else if (mXLabels.getPosition() == XLabels.XLabelPosition.TOP) {

                xtop = xlabelheight;

            } else if (mXLabels.getPosition() == XLabels.XLabelPosition.BOTH_SIDED) {
    ...
    private void drawXLabels() {
        ...
        } else if (mXLabels.getPosition() == XLabels.XLabelPosition.BOTTOM) {

            drawXLabels(getHeight() - mOffsetBottom + mXLabels.mLabelHeight + yoffset * 1.5f);

        } else if (mXLabels.getPosition() == XLabels.XLabelPosition.BOTTOM_INSIDE) {

            drawXLabels(getHeight() - getOffsetBottom() - yoffset);

        } else if (mXLabels.getPosition() == XLabels.XLabelPosition.TOP_INSIDE) {
    ...
    private void drawYLabels() {
        ...
        } else if (mYLabels.getPosition() == YLabels.YLabelPosition.RIGHT_INSIDE) {

            mYLabelPaint.setTextAlign(Align.RIGHT);
            drawYLabels(getWidth() - mOffsetRight - xoffset, positions, yoffset);

        } else if (mYLabels.getPosition() == YLabels.YLabelPosition.LEFT_INSIDE) {
